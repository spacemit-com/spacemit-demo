...
def get_args():
    ...
    parser.add_argument("--vit-model", type=str, default="../model/sam_vit_b_encoder.onnx", help="vit model path.")
    parser.add_argument("--decoder-model", type=str, default="../model/sam_decoder.onnx", help="decoder model path.")    
    parser.add_argument("--warmup", type=int, default=0, help="Warmup epoch. if set 0, model won`t warmup.")
    parser.add_argument("--output", type=str, default="result.jpg", help="Path to the directory where masks will be output.")
