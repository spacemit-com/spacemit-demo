...
class Yolov6Detection:
    ...
    def infer(self, image):    
        ...
        if (scores.any() > self.conf_threshold):            
            input_size = (320, 320)
            ...
            dets[:, 3] *= scale_y
            # Draw boxes on image
            result_image = self.draw_results(image, scores, dets, labels_pred, labels)
    ...
    # Draw boxes on image
    def draw_results(self, image, scores, dets, labels_pred, labels):    
