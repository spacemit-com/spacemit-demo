import cv2
import argparse
from utils import Yolov6Detection


def main():
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='YOLOv6 ONNX Inference')
    parser.add_argument('--model', type=str, default='../model/yolov6p5_n.q.onnx' , help='Path to the YOLOv6 ONNX model')
    ...
    detector = Yolov6Detection(args.model, args.conf_threshold)
    ...
    if args.use_camera:        
        ...
        while True:
            ...
            # Show result 
            cv2.imshow('YOLOv6 Inference', result_image)
