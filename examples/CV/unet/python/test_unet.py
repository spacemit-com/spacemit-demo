...
def main():
    ...
    parser.add_argument('--model', type=str, default='../model/unet-s5.q.onnx', help='Path to the Unet ONNX model')
    parser.add_argument('--image', type=str, default='../data/test_unet.jpg', help='Path to the input image')
