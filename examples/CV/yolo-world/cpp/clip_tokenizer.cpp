...
std::vector<std::pair<std::string, std::string>> CLIPTokenizer::Impl::get_pairs(const std::vector<std::string>& word) {
...
CLIPTokenizer::CLIPTokenizer() : pImpl(std::make_unique<Impl>()) {}
