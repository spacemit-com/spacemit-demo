...
import numpy as np
import argparse
from utils import  Yolov8OBBDetection


def main():
    parser = argparse.ArgumentParser(description='YOLOv8 ONNX Inference')
    parser.add_argument('--model', type=str, default='../model/yolov8n-obb.onnx', help='Path to the YOLOv8 ONNX model')
    parser.add_argument('--image', type=str, default='../data/obb_demo.jpg', help='Path to the input image')
    ...
    # Create detector 
    detector = Yolov8OBBDetection(args.model,args.conf_threshold,args.iou_threshold)
